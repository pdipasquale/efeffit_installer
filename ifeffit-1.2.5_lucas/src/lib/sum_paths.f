...
cc          if (iprint.ge.9) then
cc             print*, 'degen,s02,e0,ei =',degen,
cc     $            param(jfps02), param(jfpe0), param(jfpei)
cc             print*, 'dphas,delr,sig2 =',
cc     $            param(jfppha),param(jfpdr),param(jfpss2)
cc             print*, 'theamp(28,jfeff)=', theamp(28,jfeff)
cc             print*, 'qfeff(28,jfeff) =',  qfeff(28,jfeff)
cc          end if
       end if
       return
       end
