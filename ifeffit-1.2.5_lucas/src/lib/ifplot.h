...
c parameters:
       ...
       integer   ipgwin(4), icurwin, imarker(mplabs), iarrow(mparro)
...
cc  common /chrplt/ pltdev, pltfil,xlabel, ylabel, ptitle, plabel
     ...
     $      yplabs, xlim, tlim, axisiz, txtsiz,  xkey_loc,
     $      xmarks, ymarks, xarros, iarrow, imarker,
