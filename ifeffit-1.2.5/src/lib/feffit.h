c{feffit.h -*-fortran-*-
       ...
       double precision lfs_chiq(maxpts),lfs_thiq(maxpts)
       double precision lfs_qwindo(maxpts), lfs_resq(maxpts)
       double precision lfs_dchiq(maxpts), lfs_kq(maxpts)
       double precision lfs_kweight
       integer          lfs_nqfit
...
c  for multiple-k-weights in fit
       ...
       common /lfsarr/ lfs_chiq, lfs_thiq,
     $  lfs_qwindo, lfs_resq, lfs_kq,
     $  lfs_dchiq, lfs_nqfit
       common /lfsds/ lfs_kweight
